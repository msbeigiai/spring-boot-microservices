...
public class OrderControllerTest {
    ...
    @Test
    public void test_When_Place_Order_With_Wrong_Access_ThenThrow403() throws Exception {
        OrderRequest orderRequest = getMockOrderRequest();
        MvcResult mvcResult =
                mockMvc.perform(MockMvcRequestBuilders.post("/order/placeOrder")
                                .with(jwt()
    ...
    @Test
    public void test_When_Get_Order_Is_Success() throws Exception {
    ...
    @Test
    public void test_When_Get_Order_Order_Not_Found() throws Exception {
        MvcResult mvcResult =
                mockMvc.perform(MockMvcRequestBuilders.get("/order/10")
                                .with(jwt().authorities(new SimpleGrantedAuthority("Admin")))
                                .contentType(MediaType.APPLICATION_JSON_VALUE))
